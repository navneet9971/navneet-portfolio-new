  ...
  return (
    <section id="myskills" className="py-20 bg-black">
      <div className="container mx-auto px-4">
        ...
        {/* Mobile UI - Horizontal Scrollable Cards - No Animation */}
        ...
        {/* Mobile Stats - Compact Design - No Animation */}
        <div className="lg:hidden text-center mb-16">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400 mb-1">
                  <CountUp end={skills.length} duration={2.5} />
                </div>
        ...
        {/* Desktop Skill Summary - With Animation */}
